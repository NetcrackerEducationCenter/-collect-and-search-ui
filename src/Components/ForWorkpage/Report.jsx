...
function Report(props) {
    ...
    const downloadTxtFile = () => {
        ...
        // element.download = `Request_${props.report.requestId}.txt`;
        element.download = `Request_36435.txt`;
        ...
        return (
            <Container fluid>
                ...
                <Container className='mb-3' fluid id='p'>
                    ...
                    <Button className='bg-0 border border-aqua' onClick={downloadTxtFile}>
                        Download text
                    </Button>
        </Container>
    );
